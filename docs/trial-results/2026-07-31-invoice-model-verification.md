...
- 通过：老板驾驶舱关键数据表存在。tblbak9mUexa0ZKB
- 通过：计划唯一键不为空。blank=0
- 通过：明细唯一键不为空。blank=0
- 通过：计划唯一键不重复。[]
- 通过：明细唯一键不重复。[]
...
- 通过：老板驾驶舱只有经营项目总览和走账项目总览。rows=2, invalid=0
- 通过：经营项目总览项目数匹配项目分类。dashboard=78, overview=78
- 通过：走账项目总览项目数匹配项目分类。dashboard=29, overview=29
- 通过：老板驾驶舱完成率不超过100%。rows=0
