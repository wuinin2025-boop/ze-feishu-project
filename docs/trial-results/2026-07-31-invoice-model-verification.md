...
- 旧项目补录记录数（只读检查）：266
- 源发票记录数：213
- 统一明细纳入统计开票金额：53146650.25
- 源发票抵消后纳入统计开票金额：53146650.25
...
- 通过：计划唯一键不重复。[]
- 通过：明细唯一键不重复。[]
- 通过：统一明细开票金额等于源发票抵消后金额。detail=53146650.249999985, source=53146650.24999999
